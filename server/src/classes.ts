...
// The roster of playable classes. Stats are loosely D&D 5e-flavored but
// simplified for an MVP. Each class has a couple of signature abilities the
// rules engine and AI DM can reference.
